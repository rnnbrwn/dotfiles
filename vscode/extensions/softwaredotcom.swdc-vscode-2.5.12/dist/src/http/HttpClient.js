...
beApi.defaults.headers.common["X-SWDC-Plugin-UUID"] = Util_1.getPluginUuid();
const spotifyApi = axios_1.default.create({});
function serverIsAvailable() {
    return __awaiter(this, void 0, void 0, function* () {
        const isAvail = yield softwareGet("/ping", null)
            .then((result) => {
 ...
 * @param jwt
 */
function softwareGet(api, jwt, queryParams = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        if (jwt) {
            beApi.defaults.headers.common["Authorization"] = jwt;
        }
        return yield beApi.get(api, { params: queryParams }).catch((err) => {
