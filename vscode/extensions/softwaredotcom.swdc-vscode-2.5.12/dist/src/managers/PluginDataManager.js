...
class PluginDataManager {
    ...
    midnightCheckHandler() {
        return __awaiter(this, void 0, void 0, function* () {
            if (Util_1.isNewDay()) {
                ...
                yield TimeSummaryData_1.clearTimeDataSummary();
    ...
    */
    processPayloadHandler(payload, nowTimes, isUnfocus = false) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    populatePayloadProject(payload) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            p.identifier = (_a = resourceInfo === null || resourceInfo === void 0 ? void 0 : resourceInfo.identifier) !== null && _a !== void 0 ? _a : "";
            payload.project = p;
        });
    }
    /**
    ...
    updateAggregateInfo(fileChangeInfoMap, payload, sessionSeconds) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            aggregate.directory = payload.project ? payload.project.directory || Constants_1.NO_PROJ_NAME : Constants_1.NO_PROJ_NAME;
