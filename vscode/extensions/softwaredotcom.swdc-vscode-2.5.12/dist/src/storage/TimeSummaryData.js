...
exports.getTodayTimeDataSummary = exports.getCodeTimeSummary = exports.incrementSessionAndFileSecondsAndFetch = exports.updateSessionAndEditorTime = exports.incrementEditorSeconds = exports.getCurrentTimeSummaryProject = exports.clearTimeDataSummary = exports.getTimeDataSummaryFile = void 0;
        ...
        if (!workspaceFolder || !workspaceFolder.name) {
            ...
            if (rootPath) {
                ...
                try {
                    ...
                    console.error("Error getting resource info: ", e);
                }
            }
        }
        return project;
...
function updateSessionAndEditorTime(sessionSummaryActiveCodeTimeMinutes) {
    return __awaiter(this, void 0, void 0, function* () {
        const { day } = Util_1.getNowTimes();
        const codeTimeSummary = getCodeTimeSummary();
        // find out if there's a diff
        const diffActiveCodeMinutesToAdd = codeTimeSummary.activeCodeTimeMinutes < sessionSummaryActiveCodeTimeMinutes
        ...
        try {
            ...
            console.error("Error getting time data summary : ", e);
        }
        // save the info to disk
...
exports.updateSessionAndEditorTime = updateSessionAndEditorTime;
